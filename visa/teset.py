...
_host = '192.168.110.22'
_port = 5025

rm = ResourceManager('@py') # visa 객체를 생성합니다.

# 지정한 HOST와 PORT를 사용하여 서버에 접속합니다. 
psa_client = rm.open_resource(f"TCPIP::{_host}::INSTR")

print (psa_client.query('*IDN?')) # 기기 정보를 출력합니다.

psa_client.write(f":MMEM:STOR:SCR 'R:PICTURE.GIF'") # PSA screenshot
